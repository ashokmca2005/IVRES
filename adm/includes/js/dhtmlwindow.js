...
imagefiles:['images/spacer.gif', 'images/spacer.gif', 'images/spacer.gif', 'images/spacer.gif'],
...
init:function(t){
	...
	domwindowdata+='</div>'
	//domwindowdata+='<div  class="drag-contentarea" Style="width:500px;height:500px;">'
	domwindowdata+='<div id = "googlebox_p" class="drag-contentarea"></div>'
	//domwindowdata+='</div>'
...
open:function(t, contenttype, contentsource, title, attr, recalonload){
	...
	/* ----------------		FOR SET THE DIV WINDOW LOCATION -------------------------*/
	x = getValue("xAxis")+2;
	y = getValue("yAxis")+5;
	/* ----------------		FOR SET THE DIV WINDOW LOCATION -------------------------*/
	...
	var xpos=getValue("center")? x : getValue("left") //Get x coord of window
	var ypos=getValue("center")? y : getValue("top") //Get y coord of window
...
setupdrag:function(e){
	...
	if (t.contentarea.datatype=="iframe"){ //if content of this window div is "iframe"
		t.style.backgroundColor="#efe0ed" //colorize and hide content div (while window is being dragged)
