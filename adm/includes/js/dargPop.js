...
function toggleLayer1( whichLayer1 )
{
  ...
  vis = elem.style;
//var one=document.getElementById('UniqueSleeps');
//document.getElementById('UniqueSleeps').style.opacity = ('10');
//one.style.color = "red";
...
//document.getElementById('UniqueSleeps').style.display='block';
	//var one=document.getElementById('UniqueSleeps');
