...
if(isset($_GET['edit']) && $_GET['edit'] != "") {
	...
	foreach($propertyPricesArr as $vaule) {
		if($vaule['id'] == $property_price_id) {
			...
			list($txtMonthFrom, $txtDayFrom, $txtYearFrom) = split('[/.-]', date('m-d-Y', strtotime($vaule['date_from'])));			
			list($txtMonthTo, $txtDayTo, $txtYearTo) = split('[/.-]', date('m-d-Y', strtotime($vaule['date_to'])));
			$dateFromUnix 			= mktime(0, 0, 0, $txtMonthFrom, $txtDayFrom, $txtYearFrom);
			$dateToUnix	 			= mktime(0, 0, 0, $txtMonthTo, $txtDayTo, $txtYearTo);
			$dateFrom 				= date('m/d/Y', strtotime($vaule['date_from']));
			$dateTo 				= date('m/d/Y', strtotime($vaule['date_from']));
		}
	}
}
	...
	<table width="690" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td align="left" valign="top" class="pad-btm10">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td valign="middle" align="right" width="100" class="pad-rgt5">Select a currency</td>
						<td valign="middle">
					...
					<tr>
						...
						<td valign="middle">
							<select name="txtRateType" id="txtRateType" class="selectBox175" >
								<option value="1" <?php if(isset($e_rateType) && ($e_rateType=='1')){echo "selected";} ?>>Per person per night</option>
								<option value="2" <?php if(isset($e_rateType) && ($e_rateType=='2')){echo "selected";} ?>>Per night</option>
								<option value="3" <?php if(isset($e_rateType) && ($e_rateType=='3')){echo "selected";} ?>>Per person per week</option>
								<option value="4" <?php if(isset($e_rateType) && ($e_rateType=='4')){echo "selected";} ?>>Per week</option>
							</select>
						</td>
		...
		<tr>
            ...
            <div id="showAddPriceFrm" class="width690 dash-top pad-top15">
                <div class="width690 <?php if(is_array($propertyPricesArr) && count($propertyPricesArr) > 0) { echo " dash-btm pad-btm20";} ?>">
                    <table width="96%" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        ?>
                        <tr>
                            <td class="pad-rgt5" width="89" align="right" valign="middle">Name</td>
                            <td width="637" colspan="2" align="left" valign="middle">
                                <span style="float:left;">
                                <input name="txtRateName" id="txtRateName" type="text" class="inpuTxt260" value="<?php if(isset($_POST['txtRateName'])){echo $_POST['txtRateName'];}else{echo $e_rateName;}?>" maxlength="25" onkeydown="limitText(this.form.txtRateName,this.form.txtNameCountdown,25);" onkeyup="limitText(this.form.txtRateName,this.form.txtNameCountdown,25);" onfocus="showField('txtNameCountdownId');" />
                                </span>
                                <span class="error" id="txtNameCountdownId" style="float:left;"><?php if(array_key_exists('txtRateName', $form_array)) {echo $form_array['txtRateName'];} else { echo "<input readonly type=\"text\" name=\"txtNameCountdown\" onfocus=\"this.form.txtRateName.focus();\" size=\"1\" value=\"".(25-strlen($e_rateName))."\" style=\"padding:0 0px 0 2px;background-color:".$counterBgColor."; top:1px; left:-1px; position:relative; text-align:left; width: 15px; border:0px solid #FFFFFF; color:#333333;\">";}?> <font color="#333333">characters remaining</font></span>
                            </td>
                        </tr>
					...
					<?php /*?>
                        ...
                        <tr><td class="pad-btm10" colspan="3"></td></tr>
                        <tr>
                            <td class="pad-rgt5" align="right" valign="middle">Special offer ?</td>
                            <td colspan="2" align="left" valign="middle" class="pad-btm3">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="pad-rgt15 pad-left7" valign="middle"><strong>YES</strong></td>
                                        ...
                                        <td class="pad-lft5" valign="middle"><strong>NO</strong><span class="pad-lft5 font11">Special offer will be highlighted on your listing</span></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
			...
			if(is_array($propertyPricesArr) && count($propertyPricesArr) > 0) {
				...
				echo "<tr>";
				echo "<td class=\"PricesHeadV\" style=\"width:155px;\">Rental period</td>";
				echo "<td class=\"PricesHeadV\" style=\"width:85px;\">Date from</td>";
				echo "<td align=\"center\" class=\"PricesHeadV\" style=\"width:85px;\">Date to</td>";
				echo "<td align=\"center\" class=\"PricesHeadV\" style=\"width:60px;\">Min stay</td>";
				echo "<td align=\"center\" class=\"PricesHeadV\" style=\"width:100px;\">Price / month</td>";
				echo "<td align=\"center\" class=\"PricesHeadV\" style=\"width:100px;\">Price / week</td>";
				echo "<td align=\"center\" class=\"PricesHeadV\" style=\"width:100px;\">Price / night</td>";
				echo "<td align=\"right\" class=\"PricesHeadV\">Actions</td>";
				echo "</tr>";
			
				for($i=0; $i<count($propertyPricesArr); $i++){
					$property_price_id		= $propertyPricesArr[$i]['id'];
					$priceName 				= $propertyPricesArr[$i]['price_name'];
					$dateFrom 				= date('j M, Y', strtotime($propertyPricesArr[$i]['date_from']));
					$dateTo 				= date('j M, Y', strtotime($propertyPricesArr[$i]['date_to']));
				...
				//	echo "<td align=\"center\" class=\"".$rowStyle."\" id=\"price_cell_id3".$i."\">".$strPerNightWeekendPrice."</td>";
					echo "<td align=\"right\" class=\"".$rowStyle."\" id=\"price_cell_id4".$i."\"><a href=\"admin-pending-approval.php?sec=".$sec."&subsec=pri&pid=".$property_id."&edit=".$property_price_id."\">edit</a> | <a href=\"JavaScript:void(0);\" onClick=\"addDelPriceId('".$property_price_id."');toggleLayer1('delete-pop');\">remove</a></td>";
					echo "</tr>";
				}
				echo "</table>";
				echo "</td>";
...
<div class="width690">
	<div class="pad-btm15" align="right">
