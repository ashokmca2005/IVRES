    ...
    <div class="width690" style="padding-top:15px; padding-bottom:40px;">
        <div class="width690 pad-btm30">
            <div class="FloatLft pad-top5">
                <span class="font16-darkgrey pad-rgt5">Enter your contact details for holidaymaker enquiries</span>
                <div class="pad-top7">(These will be displayed on your listing)</div>
            </div>
        ...
        <table width="690" align="left" border="0" cellpadding="5" cellspacing="0">
            <tr>
                <td width="155" align="right" valign="middle">Contact name</td>
            ...
            <tr>
                ...
                <td colspan="2" valign="middle">
                    ...
                    <?php
                        ...
                        <tr><td colspan="4" class="pad-top5"><a href="#" onclick="addEvent1(); return false;" class="add-photo">Add another number</a></td></tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td align="right" valign="top">Language spoken</td>
                <td colspan="2" valign="middle">
                    <table border="0" cellspacing="0" cellpadding="0">
                    <?php
                        ...
                        <tr>
                            <td colspan="2" class="pad-top5"><a href="#" onclick="addEvent2(); return false;" class="add-photo">Add another language</a></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td align="right" valign="middle">Enquiry response time</td>
                <td valign="middle" colspan="2">
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="pad-rgt10" colspan="2">How quickly would you normally respond to an enquiry?</td>
                        </tr>
                    </table>
                </td>
            </tr>
