...
if($_POST['securityKey']==md5(REVIEWDELETE)){
	if($_GET['sec'] == 'test') {
		...
		echo "<script> location.href='admin-pending-approval.php?sec=testi';</script>";
	}
}


if($_POST['securityKey']==md5(TESTIREJECT)){
...
if($_POST['securityKey']==md5(REVIEWDELETE)){
	if(isset($_POST['txtTestimonialId']) && $_POST['txtTestimonialId'] != "") {
		$testimonial_id = $_POST['txtTestimonialId'];
		$propertyObj->fun_delPropertyReview($testimonial_id);
	}
	echo "<script> location.href='admin-pending-approval.php?sec=testi';</script>";
}
	...
	*/
	...
	function sbmtReviewDelete(){
		...
		if(document.getElementById("txtDeclineId5").checked && document.getElementById("other_reason").value != ""){
			...
			document.getElementById("securityKey").value = "<?php echo md5('TESTIREJECT')?>";
			document.frmAddTestimonial.submit();
...
<form name="frmAddTestimonial" id="frmAddTestimonial" action="admin-pending-approval.php?sec=testi&testid=<?php echo $testimonialInfoArr['testimonial_id']; ?>" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="font12">
    ...
    <tr>
        <td valign="top"><a href="admin-pending-approval.php?sec=testi" class="back">Back to List</a></td>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#f5f5f5" id="txtshwRjctTblId" style="display:none;">
													...
													<tr>
														<td colspan="2" class="pad-top10 pad-lft10">
                                                            ...
                                                            <a href="javascript:sbmttestiReject();" style="text-decoration:none;"><img src="images/send.png" alt="Cancel" width="66" height="21" /></a>
                                                        </td>
													</tr>
												</table>
											</td>
											...
											<td colspan="2" align="right" valign="top" class="header">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td align="right" valign="bottom"><a href="admin-pending-approval.php?sec=testi" style="text-decoration:none;"><img src="images/cancelChangesN.png" alt="Cancel" width="119" height="21" /></a>&nbsp;<a href="javascript:void(0);" onclick="frmValidateAddReview();" style="text-decoration:none;"><img src="images/saveChangesN.png" alt="Save Approve" width="108" height="21" border="0" /></a></td>
													</tr>
												</table>
											</td>
										</tr>
				...
				<td colspan="2" valign="top">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="EventListing">
						...
						<tbody>
                            ...
                            ?>
                                <tr>
                                    <td class="left"><a href="admin-pending-approval.php?sec=testi&testid=<?php echo $testimonial_id;?>"><?php echo fill_zero_left($testimonial_id, "0", (6-strlen($testimonial_id)));?></a></td>
