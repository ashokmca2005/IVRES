...
<table width="694" border="0" cellspacing="0" cellpadding="0" class="font12">
    ...
    <tr>
        <td colspan="2" align="left" valign="top">
            ...
            <p class="pad-btm10">What have you got to lose, as well as all the other fantastic benefits of advertising on <?php echo $_SERVER["SERVER_NAME"];?> you will now get the chance to fill your property ALL YEAR ROUND. </p>
        </td>
    </tr>
    <tr>
