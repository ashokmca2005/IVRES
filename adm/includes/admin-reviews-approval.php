...
if($_POST['securityKey']==md5(REVIEWDELETE)){
	...
	echo "<script> location.href='admin-pending-approval.php?sec=review';</script>";
}
...
<form name="frmAddReview" id="frmAddReview" action="admin-pending-approval.php?sec=review&reviewid=<?php echo $reviewInfoArr['review_id']; ?>" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="font12">
    ...
    <tr>
        <td valign="top"><a href="admin-pending-approval.php?sec=review" class="back">Back to List</a></td>
...
//							$created_on			= $reviewListArr[$i]['created_on'];
                            ...
                            ?>
                                <tr>
                                    <td class="left"><a href="admin-pending-approval.php?sec=review&reviewid=<?php echo $review_id;?>"><?php echo fill_zero_left($review_id, "0", (6-strlen($review_id)));?></a></td>
