    ...
    <table width="690" border="0" cellspacing="0" cellpadding="0" class="pad-top7">
        <tr>
            <td align="left" valign="top">
                <div class="FloatLft font16-darkgrey">Where is your accommodation?</div>
            ...
            <td align="left" valign="top">
                <table width="690" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td align="left" valign="top">Not found <a href="javascript:void(0);" onclick="notFoundRegion();" class="blue-link">click here</a></td>
					</tr>
					<tr>
						<td align="left" valign="top">Specific location</td>
						<td align="left" valign="top" class="pad-btm5">
					...
					<tr>
						<td align="left" valign="top">Postcode</span></td>
						...
						<td align="left" valign="top"><span style="color:#333333; font-size:11px;"><strong>NOTE:</strong> Please use the <strong>FULL postcode / zipcode</strong> for the property. This may include international and regional codes.</span></td>
					</tr>
					<tr>
						<td align="left" valign="top">&nbsp;</td>
						<td align="right" valign="top" class="pad-btm5 pad-rgt5">
							<a href="javascript:void(0);" onclick="return showPropertyOnMap();" class="button-blue">Find property on map</a>
						</td>
						<td align="left" valign="top">
							<div class="FloatLft">
...
-->
        ...
        <tr>
            <td align="left" valign="top" style="padding-top:20px;">
                ...
                <table width="690" border="0" cellspacing="0" cellpadding="0">
					<tr><td align="left" valign="top"><div class="FloatLft font16-darkgrey">Now find it on the google map</div></td></tr>
					<tr>
						<td align="left" valign="top" style="padding-right:0px;padding-top:5px;padding-bottom:15px;">
							To move the pin to the exact location of your accommodation. Just click and hold on the marker. Drag it to the exact location and drop it, and drop it over the exact location of your accommodation
						</td>
					</tr>
                    <tr>
        ...
        <tr><td align="left" valign="top"><div class="width690 dash41">&nbsp;</div></td></tr>
			<tr>
				<td align="left" valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td align="left" valign="top" class="owner-headings">Distances</td>
							<td align="right">
								<table border="0" align="right" cellpadding="0" cellspacing="0">
									<tr>
										<td align="right" style="padding-right:6px;">Distances calculated in</td>
										<td align="right">
											<?php
			...
			<tr>
				<td align="left" valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td align="left" valign="top" class="pad-btm15 pad-top10"><a href="#" onclick="addEvent();" class="add-photo">Add another distance</a> Such as distance from a local landmark or feature</td>
						</tr>
					</table>
					</div>
				</td>
			...
			<tr>
				<td align="left" valign="top" class="owner-headings">Describe the area</td>
			</tr>
			<tr>
				<td align="left" valign="top" class="pad-btm15">
					This is your chance to tell holidaymakers what the area is really like. Give them details such as great places to eat or things to do and see. Holidaymakers are not just choosing your accommodation they’re choosing your location too! <a href="#" onclick="MM_openWindow('property-add-location-help-pop-up.php','childwindow','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=700,height=800')" class="blue-link">see examples</a>
                </td>
			</tr>
			<tr>
				<td align="left" valign="top">
