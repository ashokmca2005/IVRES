<table width="100%" border="0" cellspacing="0" cellpadding="0" id="innerright">
    <tr>
       ...
       <td align="left" valign="top" class="width210 dash-right">
        ...
        <td align="left" valign="top" class="width26">&nbsp;</td><?php */?>
                    ...
                    <tr>
                        <td width="395" align="left" valign="top">
                            <table width="395" border="0" cellspacing="0" cellpadding="0">
                                <tr><td colspan="2" align="left" valign="top"><h1 class="page-heading"><?php echo $tvlguidInfoArr['trvl_guid_title']; ?></h1></td></tr>
                                <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    if(isset($tvlguidMainPhoto) && $tvlguidMainPhoto !="") {
                                                                        ...
                                                                        echo "<img src=\"".$tvlguidMainPhoto."\" alt=\"".$tvlguidMainPhotoCaption."\" id=\"txtTvlGuidPhotoId\" width=\"650\" height=\"380\" />";
                                                                        echo "</td>";
                                                                        echo "</tr>";
																		/*
																		echo "<tr>";
                                                                    ...
                                                                    for( $i = 0; $i < count($tvlguidImgInfoArr); $i = $i+6) {
                                                                        ...
                                                                        if( isset( $photoid_1 ) && $photoid_1 !="" ){
                                                                            ...
                                                                            $photothumb_1 	= TVLGUID_IMAGES_THUMB168x127_PATH.$tvlguidImgInfoArr[$i+0]['photo_url'];
...
<?php /*?>                        <td width="210" align="right" valign="top" class="pad-top20 dash-right">&nbsp;</td>
<?php */?>                        <!--<td width="198" align="right" valign="top" class="pad-top20">-->
							<?php //require_once(SITE_INCLUDES_PATH.'holiday-travelguides-right-links.php'); ?>
                        </td>
                    </tr>
                </table>
                <?php
...
//																$tvlguidMainPhotoThumb 	= TVLGUID_IMAGES_THUMB168x127_PATH.$tvlguidMainImgInfoArr['photo_thumb'];
																...
																<tr>
																	<td align="left" valign="top">
																		<table border="0" cellpadding="0" cellspacing="0" class="listingTable">
                                                                            ...
                                                                            <tr><td valign="top" class="pad-top20 pad-btm5"><img src="<?php echo $tvlguidMainPhoto; ?>" alt="<?php echo $tvlguidMainPhotoCaption; ?>" height="31" width="4" /></td></tr>
                                                                            <tr>
						...
						?>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr><td colspan="2" align="left" valign="top" class="pad-btm10 pad-top20"><h1 class="page-heading">Top attractions</h1></td></tr>
                                <tr>
                                    <td colspan="2" align="left" valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td colspan="2" align="left" valign="top" class="pad-top10">
                                                    <span class="pad-btm15">Here are just a few of the amazing things to do and see worldwide. Here are just a few of the amazing things to do and see worldwide. Here are just a few of the amazing things to do and see worldwide. Here are just a few of the amazing things to do and see worldwide.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                                            ...
                                                                            <td valign="top" class="pad-btm25 pad-top5">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
																						...
																						<td class="pad-lft25">
																							<h1><a href="<?php echo SITE_URL."holiday-travelguides.php?tvlguidid=".$trvl_guid_id; ?>" style="text-decoration:none; color:#357bdc;"><?php echo $trvl_guid_title; ?></a></h1>
																							<p><?php echo $tvlguidLocation; ?></p>
																							<p><?php echo $trvl_guid_desc; ?> ... <br /><a href="<?php echo SITE_URL."holiday-travelguides.php?tvlguidid=".$trvl_guid_id; ?>">read more</a></p>
																						</td>
																						<?php
																						} else {
																						?>
