    ...
    <!-- checklist tab : start here -->
        <ul>
            ...
            <li><a href="javascript: submtFrmChecklist('accommodation');" title="Accomodation Type"><img src="images/chklst-at-s.gif" width="147" height="29" border="0" /></a></li>
    ...
    <!-- tab content : starts here -->
        <div class="tcontent1">
            <h2 class="chklistQ">Q3. What type of accommodation are you looking for?</h2>
            <div class="RegFormMain1">
            <?php
				$usersObj->fun_createHolidayCheckListAccommodationType($user_id);
            ?>
            </div>
