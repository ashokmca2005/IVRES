...
function frmEdit() {
	var propid =  <?php echo $property_id; ?>;
	document.frmPropDeals.action = "owner-property.php?sec=spe&pid="+propid+"&spe=edit";
...
function frmSubmit() {
	if(document.frmPropDeals.txtTermsCondition.checked == false) {
		...
		var propid =  <?php echo $property_id; ?>;
		document.frmPropDeals.action = "owner-property.php?sec=spe&pid="+propid+"";
		document.frmPropDeals.submit();
	}
}
                ...
                <tr class="lineHight14">
                    ...
                    <td width="300">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
                            <tr>
                                <td width="100">
                                    <div class="latedealPhoto"><img src="gd1.php?img_name=<?php echo $strThumbUrl;?>&w=88&h=66" alt="<?php echo $strThumbCap;?>" title="<?php echo $strThumbCap;?>" align="middle" /></div>
                                </td>
                                                ...
                                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td class="pad-top10">
                                                            ...
                                                            <div class="FloatLft pad-lft5"><a href="javascript:location.href='owner-property.php?sec=spe&pid=<?php echo $property_id;?>'"><img src="<?php echo SITE_IMAGES;?>cancelit-gray.gif" alt="Cancel it" /></a></div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
