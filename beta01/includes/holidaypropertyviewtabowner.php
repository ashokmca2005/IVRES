<div id="tab_menu-1">
    <ul>
		...
		<?php */?>
        <li style="margin-right:0px; margin-left:6px;"><a href="#showSectionOwner" onclick="return showSection(8);" title="Owner" class="current">Owner profile</a></li>
		<?php
        if($booking_on == true) {
        ?>
...
<table border="0" align="left" cellpadding="0" cellspacing="0"  width="100%">
    <tr>
        <td valign="top">
			<?php
            $propertyObj->fun_createPropertyOwnerProfileDetails($property_id);
            ?>
        </td>
    </tr>
</table>
