...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
        <td align="left" valign="top" class="pad-btm10">
            <a href="<?php echo SITE_URL;?>owner-enquiries" class="blue-link">Back to enquiries</a>
        </td>
    </tr>
    <tr>
...
$pos = strpos($propertyMImgInfo[0]['photo_thumb'], "rentalo.com");
if($pos === false) {
	$imgthumb = PROPERTY_IMAGES_THUMB168x126_PATH.$propertyMImgInfo[0]['photo_thumb'];
} else {
	$imgthumb = $propertyMImgInfo[0]['photo_thumb'];
}
