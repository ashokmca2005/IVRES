        ...
        <td align="left" valign="top">
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    ...
                    <div class="FloatLft"><h1 class="page-headingNew">Enquiry details</h1></div>
<?php /*?>                    
                    <div class="FloatRgt pad-top15 pad-rgt5"><a href="holiday-property-preview.php?pid=<?php echo $property_id; ?>" class="blue-link">Back to property</a></div>
<?php */?>                    
                    </td>
                </tr>
                <tr>
