                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="EventListing">
                                ...
                                for($i=0; $i<count($ownerCartItemsArr); $i++){
                                    ...
                                    if($products_name == "Extra images") {
                                        ...
                                        $total_payble_amt 		+= (float)($ownerCartItemsArr[$i]['products_price']*$user_basket_quantity);
                                        if(($applypromo == true) && in_array($products_id, $productIdsArr)) {
                                        ...
                                        $products_name = "Featured property listing for ".$user_basket_quantity." months";
                                        $user_basket_quantity	= "";
                                    } else {
                                        $user_basket_quantity	= "";
                                        $total_payble_amt 		+= (float)($ownerCartItemsArr[$i]['products_price']);
                                        if(($applypromo == true) && in_array($products_id, $productIdsArr)) {
...
?>
    ...
    <tr><td valign="top" class="pad-top10"><a href="<?php echo SITE_URL; ?>owner-home" style="text-decoration:none;" class="button-blue">Checkout</a></td></tr>
<?php
}
?>    
</table>
