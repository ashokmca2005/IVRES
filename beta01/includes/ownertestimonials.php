            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    ...
                    <div class="pad-top5 pad-rgt5">
                       <p><?php echo tranText('below_are_just_some_of_the_things_people_have_been_saying_about_yoursite'); ?> <br /><br /><?php echo tranText('we_publish_nearly_every_comment_good_and_bad_in_order_to_give_you_a_fair_and_unbiased_reflection_of_the_site_We_have_very_broad_shoulders_and_will_change_what_isnt_working_for_you'); ?>. We have very broad shoulders and will change what isn't working for you !!</p>
                    </div>
                    </td>
                    <td valign="top" class="pad-top20">
                        <div class="FloatRgt pad-top20">
                            <div class="gradientV">
                                <div class="left">
                                    <div class="right">
                                    <p class="FloatLft pad-top3 pad-rgt5 font14"><span class="pink14arial">Got something to say?</span></p>
                                    <p class="FloatLft pad-left7"><a href="owner-testimonials-add.php" style="text-decoration:none"><img src="images/tellus-gray.gif" alt="Tell us"></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <td align="left" valign="top">
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    ...
                    <div><h1 class="page-headingNew"><?php echo tranText('what_people_are_saying'); ?></h1></div>
                    <div class="pad-top5 pad-rgt5">
                    <p><?php echo tranText('below_are_just_some_of_the_things_people_have_been_saying_about_yoursite'); ?> </p><br /><?php echo tranText('we_publish_nearly_every_comment_good_and_bad_in_order_to_give_you_a_fair_and_unbiased_reflection_of_the_site_We_have_very_broad_shoulders_and_will_change_what_isnt_working_for_you'); ?>.<br /><?php echo tranText('we_have_very_broad_shoulders_and_will_change_what_isnt_working_for_you'); ?>!!
                    </div>
                    </td>
                    <td valign="top" class="pad-top20">
                        <div class="FloatRgt pad-top20">
                            <div class="gradientV">
                                <div class="left">
                                    ...
                                    <p class="FloatLft pad-left7"><a href="owner-testimonials-add.php" style="text-decoration:none" class="button-blue">Tell us</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
