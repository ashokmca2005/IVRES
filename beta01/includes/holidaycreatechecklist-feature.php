    ...
    <!-- checklist tab : start here -->
        <ul>
            ...
            <li><a href="javascript: submtFrmChecklist('feature');" title="What are you looking for?"><img src="images/chklst-wrulf-s.gif" width="177" height="29" border="0" /></a></li>
    ...
    <!-- tab content : starts here -->
        <div class="tcontent1">
            <h2 class="chklistQ">Q4. What important features are you looking for?</h2><p class="ChkLstBrkt">(Tick all that apply)</p>
            <div class="RegFormMain1">
            <?php
				$usersObj->fun_createHolidayCheckListAmenitiesFeatures($user_id);
            ?>
            </div>
