...
function toggleLayer1( whichLayer1 )
{
  ...
  vis = elem.style;
//var one=document.getElementById('<?php echo $sitetitle; ?>');
//document.getElementById('<?php echo $sitetitle; ?>').style.opacity = ('10');
//one.style.color = "red";
...
//document.getElementById('<?php echo $sitetitle; ?>').style.display='block';
	//var one=document.getElementById('<?php echo $sitetitle; ?>');
