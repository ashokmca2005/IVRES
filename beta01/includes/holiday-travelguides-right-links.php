						...
						<?php
                            if(is_array($topAttractionArr)) {
                                ...
                                for($i=0; $i < count($topAttractionArr); $i++) {
									...
									if($category_name !="")
										echo "<tr><td class=\"pad-btm3 font12\"><a href=\"".SITE_URL."travel-guides/".replace_NonAlphaNumChars(strtolower($category_name))."/".replace_NonAlphaNumChars(strtolower($trvl_guid_title))."_".$trvl_guid_id."\" class=\"blue-link\">".$trvl_guid_title."</a></td></tr>";
									else
										echo "<tr><td class=\"pad-btm3 font12\"><a href=\"".SITE_URL."travel-guides/".replace_NonAlphaNumChars(strtolower($trvl_guid_title))."_".$trvl_guid_id."\" class=\"blue-link\">".$trvl_guid_title."</a></td></tr>";
                                }
                            ...
                            <tr>
                                <td>
                                    <div class="content">
                                        ...
                                        <p class="pad-top15"><a href="mailto:info@rentownersvillas.com?subject=Table Mountain" style="text-decoration:none;"><img src="<?php echo SITE_IMAGES;?>suggestGuideBtn.png" alt="Make Suggestion" width="113" height="27" /></a></p>
                                    </div>
                                </td>
                            </tr>
                        </table>
