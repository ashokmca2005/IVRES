...
<form name="frmProperty" id="frmPropertyId" action="<?php echo $linkava;?>" method="post">
            ...
            <div class="width690 dash-top pad-top15">
                <div class="width690 dash-btm pad-btm20">
                    <table width="96%" align="center" border="0" cellpadding="2" cellspacing="0">
                        ...
                        ?>
                        <tr>
                            <td width="89" align="right" valign="middle" class="pad-btm3 pad-rgt10"><strong><?php echo tranText('arrival_date'); ?></strong></td>
                            <td width="637" colspan="2" align="left" valign="top" class="pad-btm3 pad-lft5">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="pad-rgt5 pad-lft10"><strong><?php echo tranText('departure_date'); ?></strong></td>
                                        <td>
                        ...
                        <tr>
                            <td align="right" valign="top" class="pad-btm3 pad-top10 pad-rgt10"><strong><?php echo tranText('status'); ?></strong></td>
                        ...
                        <tr>
                            ...
                            <div class="FloatLft pad-rgt5">
                                <a href="#" onClick="getNightAlert();" class="button-blue">Update calendar</a>
                            </div>
    ...
    <div id="changeAvailability-pop-up" class="box cursor1" style="display:none; background:transparent; position:absolute; right:290px; top:573px;">
        <!--[if IE]><iframe id="iframe" frameborder="0" style="position:absolute;top:4px;left:204px;width:310px; height:180px;"></iframe><![endif]-->
        <div class="content">
            <div onMouseDown="dragStart(event, 'changeAvailability-pop-up');" style="position:relative; z-index:999; left:20px; width:325px;">
    ...
    <div class="calendars">
        ...
        <div class="FloatLft pad-lft15">
            ...
            <p class="available"><?php echo tranText('units'); ?></p>
            <p class="booked"><?php echo tranText('price'); ?></p>
    ...
    <div class="width690">
        <div class="FloatRgt pad-top10"><a href="#" onclick="document.getElementById('addAvailablityId').value = '1';return frmSubmit();" class="button-blue">save details</a></div>
    </div>
</form>
