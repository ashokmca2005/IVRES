...
<table border="0" align="left" cellpadding="0" cellspacing="0"  width="100%" class="font12">
    ...
    <tr>
        <td valign="top" align="center" class="box3">
            <form name="frmPropertyContactOwner" id="frmPropertyContactOwner" method="post" action="<?php echo SITE_URL;?>holiday-contact-owner-preview.php">
			...
			<input type="hidden" name="txtPropertyId" value="<?php echo $property_id; ?>" />
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <input name="txtUserFName" id="txtUserFName" type="text" class="txtBox230" placeholder="<?php echo tranText('first_name'); ?>" value="<?php if(isset($_POST['txtUserFName'])) { echo $_POST['txtUserFName']; } else if(isset($users_first_name)) { echo $users_first_name;} ?>" onkeydown="chkblnkTxtError('txtUserFName', 'showErrorUserFNameId');" onkeyup="chkblnkTxtError('txtUserFName', 'showErrorUserFNameId');" />
                        <p class="FloatLft error" id="showErrorUserFNameId"></p>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" valign="top">
                    ...
                    <tr>
                        <td align="left" valign="top">
                        <input name="txtUserPhone" id="txtUserPhone" type="text" class="txtBox230" placeholder="<?php echo tranText('phone'); ?>" value="<?php if(isset($_POST['txtUserPhone'])) { echo $_POST['txtUserPhone']; } ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td align="left" valign="top">
                        <input name="txtUserEmail" id="txtUserEmail" type="text" class="txtBox230" placeholder="<?php echo tranText('email'); ?>" value="<?php if(isset($_POST['txtUserEmail'])) { echo $_POST['txtUserEmail']; } else if(isset($users_email_id)) { echo $users_email_id;} ?>" onkeydown="chkblnkTxtError('txtUserEmail', 'showErrorUserEmailId');" onkeyup="chkblnkTxtError('txtUserEmail', 'showErrorUserEmailId');" />
                    ...
                    <tr>
                        <td align="left" valign="top" class="pad-top10">
                            <p class="FloatLft">
                                ...
                                <input type="text" name="txtArrival" id="txtArrival" class="txtBox80" value="" onchange="chkblnkTxtError('txtArrival', 'arrivalDateError');" onkeydown="chkblnkTxtError('txtArrival', 'arrivalDateError');" onkeyup="chkblnkTxtError('txtArrival', 'arrivalDateError');">
                            </p>
                    ...
                    <tr>
                        <td align="left" valign="top" class="pad-top10">
                            ...
                            <div class="contactSec" style="margin-left:0px; margin-top:5px;">
                                ...
                                <div class="font12">
									<?php
                                    $propertyObj->fun_createSelectNumField('txtAdults', 'txtAdultsId', 'select80', '', '', 1, 16);
                                    ?>
                                </div>
                            </div>
                            <div class="contactSec" style="margin-left:12px; margin-top:5px;">
                                ...
                                <div class="font12">
									<?php
                                    $propertyObj->fun_createSelectNumField('txtChilds', 'txtChildsId', 'select80', '', '', 1, 16);
                                    ?>
                                </div>
                            </div>
                            <div class="contactSec" style="margin-left:12px; margin-top:5px;">
                                ...
                                <div class="font12">
									<?php
                                    $propertyObj->fun_createSelectNumField('txtInfants', 'txtInfantsId', 'select80', '', '', 1, 16);
                                    ?>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr><td class="pad-top5 pad-btm10"><a href="javascript:void(0);" onclick="return validate();" class="button-green" style="text-decoration:none;padding:10px 90px 10px 90px;">Submit</a></td></tr>
                </table>
			</form>
        </td>
    </tr>
