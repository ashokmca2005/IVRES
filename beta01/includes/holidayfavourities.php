                ...
                <tr>
                    <td colspan="2" valign="top" class="pad-rgt10">
                        <table width="100%" border="0" cellpadding="5" cellspacing="0">
                            ...
                            <tr><td valign="top"><?php require_once(SITE_INCLUDES_PATH.'holidayfavourities-show-listing.php'); ?></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                                                ...
                                                <div class="content" style="padding-left:30px;">
                                                    <table border="0" cellpadding="4" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="middle"><input type="image" src="<?php echo SITE_IMAGES;?>search.gif" alt="Search" /></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
