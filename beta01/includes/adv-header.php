    ...
    <ul>
        ...
        if(isset($_SESSION['ses_user_id']) && $_SESSION['ses_user_id'] != "") {
            if(isset($_SESSION['ses_user_home']) && $_SESSION['ses_user_home'] != "") {
                ...
                echo '<li>Welcome '.$_SESSION["ses_user_fname"].' : <a href="'.$_SESSION["ses_user_home"].'" title="my account">'.ucwords(tranText('home')).'</a></li>';
			...
			echo '<li><a href="'.SITE_URL.'advertise" class="current">'.tranText('list_your_property').'</a></li>';
        }
        ?>
    </ul>
</div>
