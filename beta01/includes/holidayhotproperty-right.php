...
$showTotal = (count($hotPropertyArr) > 6) ? 6: count($hotPropertyArr);

?>

<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td valign="top" class="pad-rgt15 pad-top3 pad-btm10">
            <h1 class="font16-darkgrey">Featured properties</h1>
        </td>
    </tr>
    <?php
...
//					$show_price 				= $currency_symbol.$min_per_week_price." - ".$currency_symbol.$max_per_week_price." per week<br />";
        ...
        ?>
    <tr>
        <td class="pad-btm15 pad-rgt15 pad-top5">
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td ><a href="<?php echo $property_link; ?>"><img src="<?php echo $thumb_url; ?>" alt="<?php echo $thumb_cap." ".$hpPrpName." - ".$hpPrpType; ?>" border="0" width="168" height="126" /></a></td>
                </tr>
                <tr>
                    <td valign="top" class="font11 pad-top5 pad-rgt15"> <a href="<?php echo $property_link; ?>" class="blue-link font12"><strong><?php echo $hpPrpName;?></strong></a><br />
                        ...
                        <?php echo $show_price; ?> <?php echo $total_beds." - ".$scomfort_beds; ?> </td>
                </tr>
            </table>
        </td>
    </tr>
