...
if(isset($showTotalHotProp) && $showTotalHotProp > 0) {
	...
	$showTotalHotProp = (count($hotPropertyArr) > 4) ? 4: count($hotPropertyArr);
}
?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr><td valign="top" class="pad-rgt15 pad-lft5 pad-top3 pad-btm10"><h1 class="font16-darkgrey"><?php echo tranText('featured_properties'); ?></h1></td></tr>
        <?php
...
//					$show_price 				= $currency_symbol.$min_per_week_price." - ".$currency_symbol.$max_per_week_price." per week<br />";
            ...
            if(count($hpPrpBedArr) > 0){
                ...
                $scomfort_beds 		= ($hpPrpBedArr[0]['scomfort_beds'] > 1)?"sleeps ".$hpPrpBedArr[0]['scomfort_beds']."<br />":"sleeps ".$hpPrpBedArr[0]['scomfort_beds']."<br>";
            } else {
                $total_beds 		= "";
                $scomfort_beds 		= "";
            }
        ...
        ?>
        <tr>
            <td class="pad-btm15 pad-lft5 pad-rgt15 pad-top5">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr><td ><a href="<?php echo $property_link; ?>"><img src="<?php echo $thumb_url; ?>" alt="<?php echo $thumb_cap." ".$hpPrpName; ?>" border="0" width="168" height="126" class="image-border" /></a></td></tr>
                    <tr>
                        <td valign="top" class="font11 pad-top5 pad-rgt15">
                            ...
                            <a href="<?php echo SITE_URL; ?>vacation-rentals/in.<?php echo str_replace("&", "", str_replace(",", "_", str_replace(" ", "^", strtolower($hpPrpRegion)))); ?>" class="green"><strong><?php echo $hpPrpRegion; ?></strong></a><br />
                            <?php echo $show_price; ?><?php //echo $total_beds." - ".$scomfort_beds; ?>
                        </td>
                    </tr>
                </table>
            </td>
