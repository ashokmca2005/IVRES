    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="font12">
        <tr>
            <td align="left" valign="bottom" class="pad-top10">
                Thanks for telling your friends about <?php echo $sitetitle; ?>. We hope they like it as much as you do. Feel free to tell as many people as you like, the more you tell the better the site will will be.
            </td>
        </tr>
        <tr><td valign="middle" class="pad-top20"><a href="<?php if(isset($_SESSION['ses_user_home']) && $_SESSION['ses_user_home'] != "") {echo $_SESSION['ses_user_home'];} else {echo SITE_URL;} ?>" style="text-decoration:none;"><img src="images/Homepage-new.png" alt="Home" width="92" height="27" /></a>&nbsp;&nbsp;<a href="<?php echo SITE_URL."holiday-tell-a-friends.php"; ?>" style="text-decoration:none;"><img src="images/tellmorefriends-new.png" alt="Tell more friends" /></a></td></tr>
    </table>
<?php
} else {
	$userSubject = "Check out this great site about vacation rentals!";
	$userMessage = "Hi, just thought I'd let you know about rentownersvillas.com. It's a fab site that advertises budget to luxury accommodation in worldwide. Also a great travel guide.";
	?>
