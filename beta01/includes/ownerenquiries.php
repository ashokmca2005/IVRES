<?php 
	...
	$rsQuery				= $propertyObj->fun_getPropertyOwnerEnquiryArr($user_id, $strQueryParameter);
	$rsQueryCount			= $propertyObj->fun_getPropertyOwnerEnquiryArr($user_id, $strQueryCountParameter);
...
<script type="text/javascript" language="javascript">
	...
	function delMessage(){
		...
		if(document.getElementById("txtDelItem").value != "") {
			...
			req.open('get', '<?php echo SITE_URL;?>messagedeleteXml.php?enquiry_id='+strMessageId+'&owner_id=<?php echo $user_id;?>'); 
			req.send(null);   
		}
	}
                ...
                <tr>
                    <td valign="top" class="pad-rgt10">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="EventListing">
                            <thead>
                                <tr>
                                    <th width="10%" scope="col"><div><?php echo tranText('enquiry_id'); ?></div></th>
                                    <th width="20%" scope="col"><div><?php echo tranText('from'); ?></div></th>
                                    <th width="10%" scope="col"><div><?php echo tranText('property ID'); ?></div></th>
                                    <th width="25%" scope="col"><div><?php echo tranText('property_name'); ?></div></th>
                                    <th width="20%" scope="col"><div><?php echo tranText('date'); ?></div></th>
                                    <th width="15%" scope="col"><div><?php echo tranText('action'); ?></div></th>
                                </tr>
                            </thead>
                            <tbody>
							<?php
                            for($i =0; $i < count($enquiriesListArr); $i++) {
								...
								if($delete_status != "1" && $delete_status != "3") {
									...
									echo "<a href=\"owner-enquiries.php?enquiry=".$enquiry_id."&pid=".$property_id."\" class=\"blue-link\">View</a>&nbsp;&nbsp;|&nbsp;&nbsp;";
                                                ...
                                                <tr>
                                                    <td  align="left" valign="top" class="PopTxt">
                                                        <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td class="pad-top10">
                                                                    <div class="FloatLft"><a href="javascript:closeWindow();void(0);" class="button-grey" >Cancel</a>
                                                                    </div>
                                                                    <div class="FloatLft pad-lft5"><a href="javascript:delMessage();" class="button-blue">Delete</a></div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
...
?>
    <tr><td valign="top" class="pad-top10"><span class="font16-darkgrey">You currently have no inquiries ;-(</span></td></tr>
