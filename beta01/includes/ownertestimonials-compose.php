...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="font12">
    <tr>
        ...
        <div class="pad-top5 pad-rgt5 pad-btm15">
            Write a testimonial below and if it's any good we'll probably publish it on the site for other holidaymakers and holiday home owners to read. (And if it's really really good we may even send one of our team out to give you a big hug and an 'I love rentownersvillas.com' t-shirt ... and yes, before you ask, you get to choose which member of the team does the hugging!).
        </div>
        </td>
    </tr>
    <tr>
        <td align="left" valign="top" class="pad-btm20">
            <form name="frmAddTestimonial" id="frmAddTestimonial" action="owner-testimonials-add.php?testi=compose" method="post">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td valign="middle" class="pad-lft5" style="padding-bottom:0px;" colspan="3">
                        <table border="0" cellspacing="0" cellpadding="2">
                            <tr>
                                ...
                                <td width="327"><?php echo tranText('i_would_like_to_receive'); ?> <strong>rentownersvillas.com</strong> <?php echo tranText('newsletters'); ?></td>
                            </tr>
                ...
                <tr>
                    ...
                    <input type="reset" class="button-grey" value="Cancel" />&nbsp;<input type="submit" onclick="return frmValidateAddReview();" class="button-blue" value="Submit"/>
                    </td>
                </tr>
            </table>
            </form>
