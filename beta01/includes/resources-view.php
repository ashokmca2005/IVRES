<table width="974" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="width18">&nbsp;</td>
        <td align="left" valign="top" class="width210">
        ...
        <td align="left" valign="top" class="font12 width690">
            <div id="showDetails">
            	<?php
//				$resource_id = 1;
				if(isset($resource_id) && $resource_id !="") { // resource details section
					$tvlguidInfoArr = $tvlguidObj->fun_getTravelInfo($resource_id);
//					print_r($tvlguidInfoArr);
					if(is_array($tvlguidInfoArr) && count($tvlguidInfoArr) > 0) {
						$tvlguidMainImgInfoArr 	= $tvlguidObj->fun_getTravelMainImgInfo($resource_id);
						$tvlguidImgInfoArr 		= $tvlguidObj->fun_getTravelImgArr($resource_id);
					}
					if(is_array($tvlguidMainImgInfoArr) && count($tvlguidMainImgInfoArr) > 0) {
						$tvlguidMainPhotoId 		= $tvlguidMainImgInfoArr['photo_id'];
						$tvlguidMainPhoto 			= SITE_URL.TVLGUID_IMAGES_LARGE449x341.$tvlguidMainImgInfoArr['photo_url'];
                    ...
                    <tr>
                        <td width="395" align="left" valign="top">
                            <table width="395" border="0" cellspacing="0" cellpadding="0">
                                <tr><td colspan="2" align="left" valign="top" class="pad-btm10 pad-top20"><h1 class="page-heading"><?php echo $tvlguidInfoArr['trvl_guid_title']; ?></h1></td></tr>
                                <tr>
...
//                                                                        echo "<tr><td valign=\"top\" class=\"pad-btm8\"><div id=\"txtTvlGuidPhotoCaptionId\" class=\"font11\">".ucfirst($tvlguidMainPhotoCaption)."</div></td></tr>";
                                                                    ...
                                                                    for( $i = 0; $i < count($tvlguidImgInfoArr); $i = $i+6) {
                                                                        ...
                                                                        if( isset( $photoid_1 ) && $photoid_1 !="" ){
                                                                            ...
                                                                            $photothumb_1 	= SITE_URL.TVLGUID_IMAGES_THUMB168x127.$tvlguidImgInfoArr[$i+0]['photo_thumb'];
                                                                        ...
                                                                        if( isset( $photoid_2 ) && $photoid_2 !="" ){
                                                                            ...
                                                                            $photothumb_2 	= SITE_URL.TVLGUID_IMAGES_THUMB168x127.$tvlguidImgInfoArr[$i+1]['photo_thumb'];
                                                                        ...
                                                                        if( isset( $photoid_3 ) && $photoid_3 !="" ){
                                                                            ...
                                                                            $photothumb_3 	= SITE_URL.TVLGUID_IMAGES_THUMB168x127.$tvlguidImgInfoArr[$i+2]['photo_thumb'];
                                                                        ...
                                                                        if( isset( $photoid_4 ) && $photoid_4 !="" ){
                                                                            ...
                                                                            $photothumb_4 	= SITE_URL.TVLGUID_IMAGES_THUMB168x127.$tvlguidImgInfoArr[$i+3]['photo_thumb'];
                                                                        ...
                                                                        if( isset( $photoid_5 ) && $photoid_5 !="" ){
                                                                            ...
                                                                            $photothumb_5 	= SITE_URL.TVLGUID_IMAGES_THUMB168x127.$tvlguidImgInfoArr[$i+4]['photo_thumb'];
                                                                        ...
                                                                        if( isset( $photoid_6 ) && $photoid_6 !="" ){
                                                                            ...
                                                                            $photothumb_6 	= SITE_URL.TVLGUID_IMAGES_THUMB168x127.$tvlguidImgInfoArr[$i+5]['photo_thumb'];
