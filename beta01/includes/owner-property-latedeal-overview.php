    ...
    <tr>
        <td align="left" colspan="2" valign="top" class="pad-btm3">
            ...
            <div class="FloatRgt pad-top3">
                <a href="owner-property.php?sec=spe&spe=main&pid=<?php echo $property_id;?>"><img src="<?php echo SITE_IMAGES;?>add-latedeal.png" /></a>
            </div>
        </td>
    </tr>
...
//                    $strHrsLeft				= (int)(($strUnixDateFrom - $strUnixDateCur) / (60 * 60));
                ...
                <tr class="lineHight14" <?php if(($i%2) == 0) { echo "style=\"background:#FFFFFF;\""; } ?>>
                    ...
                    <td width="70" class="right" align="left" class="pad-rgt5">
                        <div><a href="owner-property.php?sec=spe&spe=cre&pid=<?php echo $txtPrpertyRef;?>&dealid=<?php echo $strDealId; ?>" class="MyPropertiesArrowLink">Edit</a></div>
