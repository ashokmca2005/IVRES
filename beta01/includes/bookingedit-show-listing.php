...
for($i =0; $i < count($propListArr); $i++) {
	...
	if(is_array($propPriceInfoArr) && (count($propPriceInfoArr) > 0)){
		...
		$show_price 	= "<span id=\"price_currency_symbol_id1".$i."\">".$currency_symbol."</span><span id=\"price_currency_price_id1".$i."\" >".$min_price."</span>-<span id=\"price_currency_symbol_id2".$i."\" >".$users_currency_symbol."</span><span id=\"price_currency_price_id2".$i."\">".$max_price."</span> p/w <br>";
	} else {
		$show_price 	= "";
	}
...
<?php */?>
                        ...
                        <div><a href="<?php echo $property_link; ?>"><img src="<?php echo SITE_IMAGES;?>detailsandavailability.gif" alt="View" width="88" height="27" /></a></div>
                    </td>
                </tr>
            </table>
        </td>
