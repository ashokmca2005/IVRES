...
<div id="wrapper">
    ...
    <div id="pg-wrapper" align="center"><h1 class="page-heading">My property bookings</h1></div>
    <div id="main">
					...
					<?php
                        if(isset($_GET['booking']) && $_GET['booking'] != "") {
                            if(isset($_GET['err']) && $_GET['err'] == "thanks") {
                                require_once(SITE_INCLUDES_PATH.'holidaypropertybookingsthanks.php');
                            } else {
                                require_once(SITE_INCLUDES_PATH.'holidaypropertybookings-details.php');
                            }
                        } else {
                            require_once(SITE_INCLUDES_PATH.'holidaypropertybookings.php');
                        }
                    ?>
                </td>
            </tr>
