...
//				@unlink($uploadtempfile);
			...
			$strXmlContent .="<photosrc>".$uploadthumbfile."</photosrc>\n";
...
//				@unlink($uploadtempfile);
			...
			$strXmlContent .="<photo>\n";
			$strXmlContent .="<photoid>".$photo_id."</photoid>\n";
			$strXmlContent .="<photosrc>".trim($uploadthumbfile)."</photosrc>\n";
			$strXmlContent .="<photostatus>File uploaded.</photostatus>\n";
			$strXmlContent .="</photo>\n";
		}
	}
	...
	if (file_exists($uploadFile)){
		...
		if($uploadFile == "/" || $uploadFile == "" || $uploadFile == "upload/"){
			$strXmlContent .="<photosrc>images/image-thumbnail.gif</photosrc>\n";
			$strXmlContent .="<photostatus>Uploading File. Please wait...</photostatus>\n";
		} else {
			$strXmlContent .="<photosrc>".$uploadFile."</photosrc>\n";
			$strXmlContent .="<photostatus>File uploaded.</photostatus>\n";
		}
		$strXmlContent .="</photo>\n";
	} else {
...
//$strXml = "";
$strXml ="<?xml version=\"1.0\" encoding=\"UTF-8\"?><photos>\n";
