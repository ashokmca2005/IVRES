<?php
	...
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
	$calendar1 .= "<td align='left'><a href='JavaScript:find_cal3(\"".$pre_year_timestamp."\", \"".$ct."\")'><img src='".SITE_URL."images/cal_img/arrow-left.gif' alt='One' border='0'/></a></td>";
	$calendar1 .= "<td align='center'>".Date('Y',$timestamp)."</td>";
	$calendar1 .= "<td align='right'><a href='JavaScript:find_cal3(\"".$next_year_timestamp."\", \"".$ct."\")'><img src='".SITE_URL."images/cal_img/gray-arrow-big.gif' alt='One' border='0'/></a></td>";
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
	$calendar1 .= "<td class='dashvk' colspan='3'><img src='".SITE_URL."images/cal_img/ANP-LftDash.gif' alt='ANP' /></td>";
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
	$calendar1 .= "<td align='left'><a href='JavaScript:find_cal3(\"".$pre_timestamp."\", \"".$ct."\")'><img src='".SITE_URL."images/cal_img/arrow-left.gif' alt='One' border='0'/></a></td>";
	$calendar1 .= "<td align='center'>".strtoupper(Date("F",$timestamp))."</td>";
	$calendar1 .= "<td align='right'><a href='JavaScript:find_cal3(\"".$next_timestamp."\", \"".$ct."\")'><img src='".SITE_URL."images/cal_img/gray-arrow-big.gif' alt='One' border='0'/></a></td>";
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
...
//		$eventDate = $yr_cal."-".$mnt_cal."-".$i;
		...
		if($mnt_cal >= date('m') && $yr_cal >= date('Y')) {
			$calendar1 .="<td bgcolor = '".$bgcolor."' style='border:1px solid #AEAEAE;' align='right' valign='bottom' ><a href='JavaScript:insert_date(\"".Date("m/d/Y",$calendertimestamp)."\",\"".$ct."\")' style='text-decoration:none;color:#666666'>".$i."</a></td>";
		} else {
			$calendar1 .="<td bgcolor = '".$bgcolor."' style='border:1px solid #AEAEAE;' align='right' valign='bottom'><a href='JavaScript:insert_date(\"".Date("m/d/Y",$calendertimestamp)."\",\"".$ct."\")' style='text-decoration:none;color:#666666'>".$i."</a></td>";
		}			
		$adj='';
