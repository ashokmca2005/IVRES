<?php
	...
	$calendar1  = "";	
	$calendar1 .= "<iframe frameborder='0' style='position:absolute;top:10px;left:18px;width:206px;height:262px' id='iframe'></iframe>";
	...
	$calendar1 .= "<tr>";
	$calendar1 .= "<td align='right' valign='top' class='leftBg'></td>";
	...
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
	$calendar1 .= "<td colspan='2'><table width='100%' border='0' cellspacing='0' cellpadding='0'>";
	$calendar1 .= "<tr>";
	$calendar1 .= "<td colspan='3' class='dashvk'><img src='".SITE_URL."images/cal_img/ANP-LftDash.gif' alt='ANP' /></td>";
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
	$calendar1 .= "<td align='left'><a href='JavaScript:find_cal5(\"".$pre_year_timestamp."\", \"".$ct."\")'><img src='".SITE_URL."images/cal_img/arrow-left.gif' alt='One' border='0'/></a></td>";
	$calendar1 .= "<td align='center'>".Date('Y',$timestamp)."</td>";
	$calendar1 .= "<td align='right'><a href='JavaScript:find_cal5(\"".$next_year_timestamp."\", \"".$ct."\")'><img src='".SITE_URL."images/cal_img/gray-arrow-big.gif' alt='One' border='0'/></a></td>";
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
	$calendar1 .= "<td class='dashvk' colspan='3'><img src='".SITE_URL."images/cal_img/ANP-LftDash.gif' alt='ANP' /></td>";
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
	$calendar1 .= "<td align='left'><a href='JavaScript:find_cal5(\"".$pre_timestamp."\", \"".$ct."\")'><img src='".SITE_URL."images/cal_img/arrow-left.gif' alt='One' border='0'/></a></td>";
	$calendar1 .= "<td align='center'>".strtoupper(Date("F",$timestamp))."</td>";
	$calendar1 .= "<td align='right'><a href='JavaScript:find_cal5(\"".$next_timestamp."\", \"".$ct."\")'><img src='".SITE_URL."images/cal_img/gray-arrow-big.gif' alt='One' border='0'/></a></td>";
	$calendar1 .= "</tr>";
	$calendar1 .= "<tr>";
...
//		$eventDate = $yr_cal."-".$mnt_cal."-".$i;
		$calendertimestamp = mktime(0,0,0,$mnt_cal,$i,$yr_cal);

		if($mnt_cal >= date('m') && $yr_cal >= date('Y')) {
			$calendar1 .="<td bgcolor = '".$bgcolor."' style='border:1px solid #AEAEAE;' align='right' valign='bottom' ><a href='JavaScript:insert_date1(\"".Date("m/d/Y",$calendertimestamp)."\",\"".$ct."\")' style='text-decoration:none;color:#666666'>".$i."</a></td>";
		} else {
			$calendar1 .="<td bgcolor = '".$bgcolor."' style='border:1px solid #AEAEAE;' align='right' valign='bottom'><a href='JavaScript:insert_date1(\"".Date("m/d/Y",$calendertimestamp)."\",\"".$ct."\")' style='text-decoration:none;color:#666666'>".$i."</a></td>";
		}			
		$adj='';
	...
	$calendar1 .="</tr></table>"."\n";
	$calendar1 .= "</table></td>";
	$calendar1 .= "<td valign='top' class='rightBg' width='12'></td>";
	$calendar1 .= "</tr>";
	$calendar1 .= "</table>";
	$calendar1 .= "</div>"; 
	echo $calendar1;
