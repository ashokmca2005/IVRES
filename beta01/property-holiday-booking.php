...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo SITE_CSS_INCLUDES_PATH;?>consolidated-base-min.css" />
    <!--[if IE 6]><link rel="stylesheet" href="<?php echo SITE_CSS_INCLUDES_PATH;?>ie6.css" type="text/css" /><![endif]-->
    <!--[if IE 7]><link rel="stylesheet" href="<?php echo SITE_CSS_INCLUDES_PATH;?>ie7.css" type="text/css" /><![endif]-->
    <!--[if IE 8]><link rel="stylesheet" href="<?php echo SITE_CSS_INCLUDES_PATH;?>ie8.css" type="text/css" /><![endif]-->
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="left" valign="top" class="font12" style="padding-left:10px;">
					<?php require_once(SITE_INCLUDES_PATH.'propertybookingpreview.php'); ?>
                </td>
            </tr>
        </table>
    </div>
