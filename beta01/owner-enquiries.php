...
<head>
    <title><?php echo $sitetitle;?> :: Owner :: Inquiry</title>
...
//        	alert(x);alert(y);
		...
		function toggleLayer(whichLayer){
			...
			else if(whichLayer == 'enquiry-delete-pop')
			{		
				var x1 = x-150;
				var y1 = y-100;
				output = '<div style="z-index:5;">'+output+'</div>';
...
<div id="wrapper">
    ...
    <div id="pg-wrapper" align="center"><h1 class="page-heading"><?php echo tranText('my_enquiries'); ?></h1></div>
    <div id="main">
                ...
                <td align="left" valign="top" class="font12" style="padding-left:10px;">
                    ...
                    if(isset($_GET['enquiry']) && $_GET['enquiry'] != "") {
                        if(isset($_GET['err']) && $_GET['err'] == "thanks") {
                            require_once(SITE_INCLUDES_PATH.'ownerenquirythanks.php');
                        } else {
                            require_once(SITE_INCLUDES_PATH.'ownerenquiry-details.php');
                        }
                    } else {
                        require_once(SITE_INCLUDES_PATH.'ownerenquiries.php');
                    }
                    ?>
                </td>
            </tr>
