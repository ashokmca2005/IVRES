...
if(isset($_REQUEST[id])) {
	$id = $_REQUEST[id];
	$sql = "SELECT region_id AS id, region_name AS name, region_desc AS description FROM " . TABLE_REGION . " WHERE region_id ='".$id."'";

	$rs = $dbObj->createRecordset($sql);
	$strOpt ="";
	echo '<?xml version="1.0" encoding="ISO-8859-1"?><regions>';
	$count=0;
