<?php require_once("includes/owner-top.php"); ?>
...
<div id="wrapper">
    ...
    <div id="pg-wrapper" align="center"><h1 class="page-heading">Resources</h1></div>
    <div id="main">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="left" valign="top" class="font12" style="padding-left:10px;">
					<?php require_once(SITE_INCLUDES_PATH.'ownerhome.php'); ?>
                </td>
            </tr>
        </table>
    </div>
