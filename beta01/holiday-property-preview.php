...
*/
	...
	$p_url = $propertyObj->fun_getPropertyFriendlyLink($property_id);
	if(isset($p_url) && $p_url != "") {
		$canonical_url 		= SITE_URL."vacation-rentals/".strtolower($p_url);
	} else {
		$canonical_url 		= SITE_URL."property.php?pid=".$property_id;
	}
?>
