...
<head>
    ...
    <title><?php echo $sitetitle;?> :: Owner :: Message</title>
...
<div id="wrapper">
    ...
    <div id="pg-wrapper" align="center"><h1 class="page-heading">Messages</h1></div>
    <div id="main">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="left" valign="top" class="font12" style="padding-left:10px;">
					<?php require_once(SITE_INCLUDES_PATH.'ownermessage.php'); ?>
                    <script>
                    open_div('checkList', 'Inbox');
                    </script>
                </td>
            </tr>
        </table>
