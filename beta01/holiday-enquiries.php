...
<div id="wrapper">
    ...
    <div id="pg-wrapper" align="center"><h1 class="page-heading">Enquiries</h1></div>
    <div id="main">
                ...
                <td align="left" valign="top" class="font12" style="padding-left:10px;">
                        ...
                        if(isset($_GET['enquiry']) && $_GET['enquiry'] != "") {
                            if(isset($_GET['err']) && $_GET['err'] == "thanks") {
                                require_once(SITE_INCLUDES_PATH.'holidayenquirythanks.php');
                            } else {
                                require_once(SITE_INCLUDES_PATH.'holidayenquiry-details.php');
                            }
                        } else {
                            require_once(SITE_INCLUDES_PATH.'holidayenquiries.php');
                        }
                        ?>
                </td>
            </tr>
