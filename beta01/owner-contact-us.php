...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo SITE_CSS_INCLUDES_PATH;?>owner.css" />
...
<div id="wrapper">
    ...
    <div id="pg-wrapper" align="center"><h1 class="page-heading"><?php echo tranText('contact_us'); ?></h1></div>
    <div id="main">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="left" valign="top" class="font12" style="padding-left:10px;">
					<?php require_once(SITE_INCLUDES_PATH.'ownercontactus.php'); ?>
                </td>
            </tr>
        </table>
    </div>
