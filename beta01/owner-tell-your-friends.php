<?php	
	...
	if($_POST['securityKey'] == md5("TELLYOURFRIEND")) {
		...
		if(($errorMsg == 'no') && ($errorMsg != 'yes')){		
			...
			redirectURL("owner-tell-your-friends.php?msg=thanks");
		} else {
...
<div id="wrapper">
    ...
    <div id="pg-wrapper" align="center"><h1 class="page-heading"><?php echo tranText('tell_your_friends'); ?></h1></div>
    <div id="main">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="left" valign="top" class="font12" style="padding-left:10px;">
					<?php require_once(SITE_INCLUDES_PATH.'owner-tellyourfriends.php'); ?>
                </td>
            </tr>
        </table>
    </div>
