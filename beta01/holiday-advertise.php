...
<div id="wrapper">
    ...
    <div id="pg-wrapper" align="center"><h1 class="page-heading">Advertise</h1></div>
    <div id="main">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="left" valign="top" class="font12" style="padding-left:10px;">
                        <?php require_once(SITE_INCLUDES_PATH.'holidayadvertise.php'); ?>
                        <script language="javascript" type="text/javascript">
                            function frmSubmit() {
                                document.frmUserRegister.submit();
                            }
                        </script>
                        <form name="frmUserRegister" method="post" action="<?php echo SITE_URL."registration"; ?>">
